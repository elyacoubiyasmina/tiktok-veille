# Script 02 — BUILD Série 1 · Épisode 1
...
> *"Si tu veux voir où ça va — follow. Parce que ça va aller vite."*

*(B-roll : Yasmina de dos ou de profil à son bureau bordelais, laptop ouvert, mains qui tapent. Le CTA passe comme une remarque en passant, jamais regardé caméra.)*
...
## 8. TEXTES OVERLAY (max 5 mots chacun)
...
**Séquence conclusion :**
- Retour sur le flacon seul, lumière qui baisse
- Canva vierge, curseur qui clignote
- Mandarine à côté du flacon (continuité script 01)

**Règles de tournage :**
- Jamais de visage de la mère — c'est l'open loop de la série
...
- **52-60s (conclusion)** : la musique retombe légèrement, on termine sur une note posée, pas triomphaliste.

**Choix principal :** son trending type "family / growth / quiet motivation" (piano + percussion douce).
**Alternative cash :** silence total + voix brute sur toute la vidéo — pattern @legend / @lisapowher. Plus disruptif, plus aligné anti-bullshit. À tester.

---

## 11. HASHTAGS (10)

`#cosmetiquemaroc` `#businessfamilial` `#rebranding` `#lancersamarque` `#buildinpublic` `#francomarocaine` `#zerobudget` `#casablanca` `#bordeaux` `#foryou`

---

## Checklist qualité

- [x] "les gars" × 2 (point 1, conclusion)
- [x] "par contre" × 1 (point 3)
- [x] "s'il vous plaît" × 1 (point 2)
- [x] "en fait" × 0
